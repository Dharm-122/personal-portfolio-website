    ...
    <footer className="border-t border-white/10 bg-zinc-950/80">
      <div className="container-page section-pad grid gap-10 lg:grid-cols-[1.4fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-4 max-w-md text-sm leading-6 text-zinc-300">{siteConfig.tagline}</p>
      ...
      <div className="border-t border-white/10">
        <div className="container-page flex flex-col gap-3 py-5 text-xs text-zinc-400 sm:flex-row sm:items-center sm:justify-between">
